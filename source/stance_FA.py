...
sem_eval_train = sem_eval_train[sem_eval_train['Stance']!='NONE'].reset_index(drop=True)
...
sem_eval_test = sem_eval_test[sem_eval_test['Stance']!='NONE'].reset_index(drop=True)

#Targets -  'Atheism' 'Climate Change is a Real Concern' 'Feminist Movement' 'Hillary Clinton' 'Legalization of Abortion'
selected_target = 'Feminist Movement' 
...
target_minority_stance = {'Atheism':'FAVOR', 'Climate Change is a Real Concern':'AGAINST', 'Feminist Movement':'FAVOR', 'Hillary Clinton':'FAVOR', 'Legalization of Abortion':'FAVOR'}
...
print("\nInitialising Model")
print(f'------------------------------------------\n')
c_tokens = [['favor','favouring','positive','good','supporting'],['against','opposing','resist','contradict','bad','disfavor']]
model, tokenizer = custom_model('bert-base-uncased', ['favor','against'], c_tokens, aggregate=True)


sem_eval_train_augmented['Label'] = None
class_labels = ['favor','against']
